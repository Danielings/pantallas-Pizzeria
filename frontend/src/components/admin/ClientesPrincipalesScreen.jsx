      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 shrink-0">
        <div>
          ...
          <p className="text-slate-500 text-sm">
            Top {VIP_LIMIT} clientes con mayor consumo de la pizzería
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4 shrink-0">
        ...
        <div className="bg-red-50/70 border border-red-100/80 rounded-2xl p-4 flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] font-extrabold text-pizza-red uppercase tracking-wider">
                Total Clientes
              </p>
              <p className="text-slate-800 text-lg font-black leading-none mt-1">
